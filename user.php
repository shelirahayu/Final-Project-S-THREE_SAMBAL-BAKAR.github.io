  ...
  <div class="card">
    ...
    <div class="card-body">
      ...
      <div class="modal fade" id="ModalTambahUser" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-1x modal-fullscreen-md-down">
              ...
              <form class="needs-validation" novalidate action="proses/proses_input_user.php" method="POST">
                ...
                <div class="row">
                  <div class="col">
                    <div class="form-floating mb-3" name="nohp">
                      <input type="text" class="form-control" id="floatingInput" placeholder="081xxxxxx" name="nohp" >
                ...
                <div class="row">
                  ...
                  <div class="form-floating">
                    <textarea class="form-control" id="" style="height: 75px" name="alamat"></textarea>
      ...
      <div class="modal fade" id="ModalView" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-1x modal-fullscreen-md-down">
          <div class="modal-content">
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
              <button type="button" class="btn btn-primary" name="input_user_validate" value="1234">Save changes</button>
            </div>
          </div>
        </div>
      </div>
